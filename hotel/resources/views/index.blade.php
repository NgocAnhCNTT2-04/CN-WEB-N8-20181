	  ...
	  <script type="text/javascript">
		...
		<div class="lastminute2 lcfix">
			...
			<div class="textleft right intro">
				...
				<div>
					<div class="list-item" style="background-color: #FF7F50">
						<h3>1.Giá rẻ bất ngờ</h3>
						<p class="text-des size-18px">Đặt phòng trực tuyến trên website giá sẽ rẻ hơn so với khi đặt trực tiếp.</p>
					</div>
					<div class="list-item" style="background-color: #00BFFF">
						<h3>2.Đa dạng và chất lượng</h3>
						<p class="text-des size-18px">Các địa điểm ở khắp mọi nơi, nhiều loại khách sạn với chất lượng cao.</p>
					</div>
					<div class="list-item" style="background-color: #B0C4DE">
						<h3>3.Dễ dàng và nhanh chóng</h3>
						<p class="text-des size-18px">Đặt phòng dễ dàng và thanh toán nhanh chóng.</p>
					</div>
				</div>
			</div>
			<div class="chart">
